...
const Comment = ({ singleCommentId, comment, ownComment, user, time, userImage }) => {
    ...
    <div className='mt-4 max-md:ml-2'>
      <div id={singleCommentId} ref={commentDiv} className="mb-8">
        <div className="flex flex-row flex-wrap mb-6">
          ...
          <h3 className="max-md:ml-3 md:ml-4 mb-1 text-lg self-center">{user} at <span className="text-sm text-gray-400 mr-2">{time}</span></h3>
